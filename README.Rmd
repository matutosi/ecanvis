...
if(!require("devtools"))        install.packages("devtools")
                                remotes::install_github("matutosi/ecan", force = TRUE)
...
Toshikazu Matsumura (2022) Ecological Analysis Visualization tools with R and shiny.  https://matutosi.shinyapps.io/ecanvis/.
