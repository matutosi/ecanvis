...
df <- 
  ...
  ## # A tibble: 197 × 10
  ##    stand species  cover    A1 Moisture Management Use      ...
  ##    <chr> <chr>    <dbl> <dbl> <ord>    <fct>      <ord>    ...
  ##  1 1     Achimill     1   2.8 1        SF         Haypastu ...
  ##  2 1     Elymrepe     4   2.8 1        SF         Haypastu ...
  ##  3 1     Lolipere     7   2.8 1        SF         Haypastu ...
  ##  4 1     Poaprat      4   2.8 1        SF         Haypastu ...
...
str(cls)
  ## List of 9
  ##  $ merge            : int [1:19, 1:2] -6 -5 -3 -9 -10 -14 -2 -11 -16...
...
isa_res_raw <- 
  ecan::ind_val(df, 
          group = "Management", 
          row_data = TRUE) # `row_data = TRUE`でlabdsv::indval()の結果のまま
