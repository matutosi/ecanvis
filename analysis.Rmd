...
```{r, echo = FALSE, eval = FALSE}
  ...
  # 植生学会では，植生学トレーニング・スクールとして植生調査の方法や解析手法の解説をしています．
  # http://shokusei.jp/baser/congress/TRAIN2025
  # このたび，以下のとおり植生調査資料の解析編を実施します．
  # 日時：2025年11月21日(金)17:00- 2時間程度
  #       2時間で終わらなければ，次週の11月28日(金)の同時間帯に続きを実施します
  # 方法：Zoomによるオンライン講習
  # 内容：植生調査資料の解析方法
  #       多様性指数，クラスター分析，序列化などの考え方とRを使った実践
  #       ※事前にRを各自でインストールしてください
  # 講師：甲南女子大学 松村俊和
  #   鹿児島大会における現地でのトレーニングスクール(植生調査方法)に参加しなかった方も参加可能です．
  #   植生学会の会員でなくても参加可能です．
  # ご希望の方は申込フォームでの登録をお願いします．
  # 当日の様子を動画で撮影する予定です．動画閲覧のみを希望の方も登録をしてください，
```
...
地点名が行ラベルとして使われているので，独立した列に変換します．
</aside>
