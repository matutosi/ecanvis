...
```{r, echo = FALSE, eval = FALSE}
  ...
  # D:/dropbox/ToDo/ecanvis/analysis.html?print-pdf/#  # pdfダメ
```
...
group <- "dummy_1"
ord_nmds_sp <- 
  ecan::ord_add_group(ord_nmds, # 抽出も実行
    score = "sp_scores", df, indiv, group)
```
...
ord_nmds_sp |>
  ...
  geom_point(
    ggplot2::aes(col = .data[[group]]), alpha = 0.4, size = 7) +
  ggplot2::geom_text() +
  ggplot2::theme_bw()
```
