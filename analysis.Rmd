...
```{r}
(ord_nmds_st <- ord_extract_score(ord_nmds, score = "st_scores"))
ord_nmds_st |>
...
```{r}
# (ord_nmds_sp <- ord_extract_score(ord_nmds, score = "sp_scores"))
indiv <- "species"
group <- "dummy_1"
ord_nmds_sp <- ord_add_group(ord_nmds, score = "sp_scores", df, indiv, group)
ord_nmds_sp
```
...
isa_res |>
  ggplot(aes(x = .data[[group]], y = .data[["ind.val"]], 
